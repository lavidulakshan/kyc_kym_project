...
import VerifyStroke from './VerifyStroke';
...
//   }, []);
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        formData.append("email", user.email); // Email from localStorage
        ...
        if(parsedUser.uid){
            formData.append("uid", parsedUser.uid);
        }
        ...
        alert("success");
           ...
           // Debug: Check FormData before submitting
  ...
  const nextStep = async () => {
    ...
    if (step === 1) {
      ...
      if (step2Errors.gender || step2Errors.bloodGroup || step2Errors.phoneNumber) {
  ...
  const renderStep = (stepNumber = step) => {
    switch (stepNumber) {
      ...
      case 2:
        return (
          <>
            {/* Gender, Blood Group, and Phone Number */}
            <div className="mb-3">
